...
namespace WPFAddressBook_2.Tests
{
    public class ContactService_Tests
    {
        ...
        {
            //arrange
            ContactModel testContact = new ContactModel { Id = new Guid("c2e79aae-411e-4938-a9d3-18cbb2ee0b47"), FirstName = "Lotta" };
            ContactService.Add(testContact);
            int currentCount = ContactService.contacts.Count;

            //act
            ContactModel editedTestContact = new ContactModel { Id = new Guid("c2e79aae-411e-4938-a9d3-18cbb2ee0b47"), FirstName = "Charlotta" };
